...
### 1. IMの読み込みと解析
- `agents/prompts/im_dd/load_im_prompt.md` の手順に従う
...
- `agents/prompts/im_dd/evaluate_prompt.md` の手順で各論点を評価し、投資推奨度を導出
...
## 参照
- 詳細ワークフロー: `agents/workflows/im_dd_workflow.md`
- プロンプト詳細: `agents/prompts/im_dd/` 配下（load_im_prompt.md, evaluate_prompt.md）
