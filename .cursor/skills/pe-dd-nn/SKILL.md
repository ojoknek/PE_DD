...
### 1. 資料の読み込みと構造化
- `.cursor/skills/pe-dd-nn/prompts/load_materials_prompt.md` の手順に従う
...
- `.cursor/skills/pe-dd-nn/prompts/evaluate_prompt.md` の手順で各論点を評価し、スコア・推奨を導出
...
## 参照
- 詳細ワークフロー: `.cursor/skills/pe-dd-nn/workflow.md`
- プロンプト詳細: `.cursor/skills/pe-dd-nn/prompts/` 配下（load_materials_prompt.md, evaluate_prompt.md）
