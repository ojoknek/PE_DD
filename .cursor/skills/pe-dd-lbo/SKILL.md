...
### 1. VDR資料の読み込みと構造化
- `.cursor/skills/pe-dd-lbo/prompts/load_vdr_prompt.md` の手順に従う
- 財務3表（IS/BS/CF）・事業計画・買収条件・負債構成・コベナンツをJSONで構造化

### 2. LBOモデルの構築
- `.cursor/skills/pe-dd-lbo/prompts/build_lbo_model_prompt.md` の18ステップに従う
...
- `.cursor/skills/pe-dd-lbo/prompts/evaluate_lbo_prompt.md` の手順で定量・定性を評価
...
## 参照
- 詳細ワークフロー: `.cursor/skills/pe-dd-lbo/workflow.md`
- プロンプト詳細: `.cursor/skills/pe-dd-lbo/prompts/` 配下（load_vdr_prompt.md, build_lbo_model_prompt.md, evaluate_lbo_prompt.md）
